...
//
//	mockgen -source=issues.go -destination=mock/issues_mock.go
//
...
func (m *MockIssueFetcher) MyIssues() ([]github_project_automation.Issue, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "MyIssues")
	ret0, _ := ret[0].([]github_project_automation.Issue)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
