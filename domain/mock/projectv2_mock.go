...
// Source: domain/projectv2.go
//
// Generated by this command:
//
//	mockgen -source=domain/projectv2.go -destination=domain/mock/projectv2_mock.go
//
...
import (
	...
	domain "github.com/igsr5/github-project-automation/domain"
...
func (m *MockProjectV2Setter) Set(categoryId, statusId string, projectItems []domain.ProjectItem) error {
	m.ctrl.T.Helper()
